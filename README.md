...
# 现货
## REST行情、交易API<br>
 [现货接口示例(仿真环境)](https://documenter.getpostman.com/view/4559526/S1ENxe7R)<br>
 [现货接口示例(生产环境)](https://documenter.getpostman.com/view/4559526/S1ENxe7S)
...
# 合约
## REST 行情、交易 API<br>
[合约接口示例（仿真环境）](https://documenter.getpostman.com/view/4559526/S1ENxe37)<br>
[合约接口示例（生产环境）](https://documenter.getpostman.com/view/4559526/S1ENxe38)
## WebSocket 行情,交易 API<br>
|**接口类型**|   **接口数据类型**   |**请求方法** |**类型**   |**描述**                     |**需要验签**        |                                                                                                                                            
  |----------- |------------------ |------------------------------------------------------------------------------------------------------------------------------------------------------------------- |---------- |---------------------------- |--------------|
  |Websocket   |市场行情接口 |         market.$symbol.kline.$period|                                                                                                            sub        |订阅 KLine 数据              |否|
